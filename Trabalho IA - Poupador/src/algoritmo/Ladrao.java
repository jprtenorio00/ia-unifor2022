 ...
 public class Ladrao extends ProgramaLadrao {
     ...
     protected int pinpointTargetLocation() {
         ...
         // FIXME: Fazer o Ladrão parar de seguir o Poupador dps que pegar as moedas ?
                 ...
                 for (int x = thiefX - 2; x <= thiefX + 2; x++) {
                     ...
                     if (0 <= x && x <= 29) {
                         if (0 <= y && y <= 29) {
                             ...
                             // do Ladrão.
                             if (this.knownField[y][x] == 100 || this.knownField[y][x] == 110) {
     ...
     protected String getLongestUnknownVertex() {
         ...
         for (String vertex : this.graph.vertexes.keySet()) {
             ...
             else if (this.isLandKnown(vertexCoordinates[0], vertexCoordinates[1])) {
                 // Adiciona o vértice e a distância ao dicionário.
